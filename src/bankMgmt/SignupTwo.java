...
public class SignupTwo extends JFrame implements ActionListener{
	...
	SignupTwo(String formno){
		...
		String educationalCategory[]= {"Non-Graduate","Graduate","Post-Graduate","Doctrate"};
		...
		String occupationCategory[]= {"Student","Self-Employed","Business","Salaried","Retired","Others"};
		...
		maritalgroup.add(seniorYes);
		maritalgroup.add(seniorNo);
		...
		emaritalgroup.add(existingYes);
		emaritalgroup.add(existingNo);
